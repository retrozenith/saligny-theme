    ...
    the_post(); ?>
                ...
                <article class="entry-article" id="post-<?php the_ID(); ?>">
                    ...
                    <div class="share-bar">
                        ...
                        <a href="https://wa.me/?text=<?php echo urlencode(get_the_title() . ' | Colegiul Tehnic "Anghel Saligny" Bucuresti ' . get_permalink()); ?>" target="_blank" rel="noopener" class="share-btn share-btn--whatsapp" title="Trimite pe WhatsApp">
                        ...
                        <a href="mailto:?subject=<?php echo rawurlencode(get_the_title() . ' | Colegiul Tehnic "Anghel Saligny" Bucuresti'); ?>&body=<?php echo rawurlencode(get_the_title() . ' | Colegiul Tehnic "Anghel Saligny" Bucuresti' . "\n" . get_permalink()); ?>" class="share-btn share-btn--email" title="Trimite prin Email">
