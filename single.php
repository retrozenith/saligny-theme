    ...
    the_post(); ?>
                ...
                <article class="entry-article" id="post-<?php the_ID(); ?>">
                    ...
                    <div class="share-bar">
                        ...
                        <a href="https://wa.me/?text=<?php echo urlencode(get_the_title() . ' ' . get_permalink()); ?>" target="_blank" rel="noopener" class="share-btn share-btn--whatsapp" title="Trimite pe WhatsApp">
